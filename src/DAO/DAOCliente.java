...
public class DAOCliente extends ConexaoMySql {
    ...
    public boolean gerarRelatorioCliente() {
        ...
        try {
            ...
            JasperExportManager.exportReportToPdfFile(jasperPrint, "D:/Documentos/Netbeans/VendasGBS/reports/relCliente.pdf");
            File file = new File("D:/Documentos/Netbeans/VendasGBS/reports/relCliente.pdf");
            try {
