 ...
 * @author geiba
 */
public class DAOVendasClientes extends conexoes.ConexaoMySql {

    public ArrayList<ModelVendasClientes> getListaVendasClientesDAO() {
        ...
        try {
            ...
            while (this.getResultSet().next()) {
                ...
                modelVendasClientes.setModelClientes(modelCliente);
